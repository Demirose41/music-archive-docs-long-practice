...
- Headers:
  - Content-Type: application/json
- Body: info about specifc artist
...
```json
{
    "name": "Chakira Chakira2",
    "artistId": 2,
    "updatedAt": "2024-11-15T06:19:17.130Z"
}
```
    ...
    "songs": [
        {
            ...
            "trackNumber": 1,
            "songId": 1,
            "createdAt": "2024-11-15T06:03:41.000Z",
            "updatedAt": "2024-11-15T06:03:41.000Z",
            "albumId": 1
        }
    ]
}
...
```json
{
    "name": "Return of the Dream Machine"
}
```
...
```json
{
    "name": "Return of the Dream Machine II"
}
```
...
```json
{
    ...
    "albumId": 2,
    "artistId": 1,
    "updatedAt": "2024-11-15T06:37:28.576Z"
}
```
...
```json
{
    ...
    "songId": 2,
    "albumId": 1,
    "updatedAt": "2024-11-15T06:59:18.538Z"
}
```
